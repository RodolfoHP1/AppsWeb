...
const QueryCompiler = require('knex/lib/dialects/cockroachdb/crdb-querycompiler');
const TableCompiler = require('knex/lib/dialects/cockroachdb/crdb-tablecompiler');
const ViewCompiler = require('knex/lib/dialects/cockroachdb/crdb-viewcompiler');
const QueryBuilder = require('knex/lib/dialects/cockroachdb/crdb-querybuilder');
